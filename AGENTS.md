# Agent guide for the Ars Énergistique BlueMap add-on
...
- Exact profile `arseng-2.1.1-beta-mc1.21.1`
...
Prototype-only implementation markers are permitted only during the fast
...
- `-ParsengJar=/path/to/arseng-2.1.1-beta.jar`
