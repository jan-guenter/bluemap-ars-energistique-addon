...
package io.github.janguenter.bluemap.arseng.adapter.bluemap523;
...
class AdapterBoundaryTest {
    ...
    void usesTheSharedResourceExtensionTypeWithoutLocalCopies() {
        ...
        assertEquals(
                Key.parse("bluemap_ars_energistique:exact_profile"),
        ...
        assertThrows(ClassNotFoundException.class, () -> Class.forName(
                "io.github.janguenter.bluemap.arseng.adapter.bluemap523."
                        + "ProfileResourceExtensionType"
        ));
        assertThrows(ClassNotFoundException.class, () -> Class.forName(
                "io.github.janguenter.bluemap.arseng.adapter.bluemap523.RegistryGuard"
        ));
    }
}
